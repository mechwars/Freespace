...
public class fs_terran_heavybeam_everyframe implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (charging) {
            ...
            if (firing && weapon.getCooldownRemaining() <= 0f && weapon.getChargeLevel() < 1f) {
                ...
                Global.getCombatEngine().addHitParticle(origin, ZERO, (float) Math.random() * 100f + 100f * weapon.getChargeLevel(), weapon.getChargeLevel() *
                                0.3f, 0.2f,
            ...
            if (weapon.getChargeLevel() > 0f && weapon.getCooldownRemaining() <= 0f) {
                ...
                Global.getSoundPlayer().playSound("bt_up_3.5", 1f, 1f, origin, weapon.getShip().getVelocity());
            }
        }
