...
public class fs_shivan_beam_effect implements BeamEffectPlugin {
        ...
        if (firing) {
            if (beam.getBrightness() < level) {
                ...
                if (Global.getCombatEngine().getTotalElapsedTime(false) - sinceLast > 0.3f) {
                    ...
                    Global.getSoundPlayer().playSound("bs_dwn_1", 1.0f, 1.0f, origin2, new Vector2f());
                }
            }
        } else {
            if (beam.getBrightness() > level) {
                ...
                if (Global.getCombatEngine().getTotalElapsedTime(false) - sinceLast > 0.3f) {
                    ...
                    Global.getSoundPlayer().playSound("bs_sred", 1f, 1.5f, origin, new Vector2f());
                }
