...
public class fs_shivan_heavybeam_everyframe implements EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (charging) {
            ...
            if (weapon.getChargeLevel() > 0f && weapon.getCooldownRemaining() <= 0f) {
                ...
                Global.getSoundPlayer().playSound("bs_up_3", 1f, 1f, origin, weapon.getShip().getVelocity());
            }
        }
